...
const variants = cva("font-light tracking-tight text-heading ", {
  variants: {
    size: {
      ...
      h4: "text-heading text-[18px] leading-[24px] font-[400] md:text-[18px] md:leading-[24px] md:font-[500] tracking-[-0.02em]",
      h5: "text-heading text-[16px] leading-[24px] font-[400] md:text-[16px] md:leading-[24px] md:font-[400] tracking-[-0.01em]",
      h6: "text-heading text-[14px] leading-[24px] font-[400] md:text-[16px] md:leading-[24px] md:font-[400] tracking-[-0.01em]",
    },
  },
})
